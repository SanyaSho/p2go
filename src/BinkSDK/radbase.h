...
// __RADBIGENDIAN__ means processor is big-endian (680x0, PPC)
  ...
  #define RADCOPYRIGHT "Copyright (C) 1994-2009, RAD Game Tools, Inc."
    ...
    #define RADSTRUCT struct
    ...
    #elif defined(SDK_ARM9) || defined(SDK_TWL) || (defined(__asm) && defined(__MWERKS__))
      ...
      #include "TargetConditionals.h"
        ...
        #undef __RADX86__
        #undef __RADMMX__
        #undef __RADBIGENDIAN__
        #undef __RAD68K__
        #undef __RADALTIVEC__
        #define __RADLITTLEENDIAN__
      ...
      #define RADRESTRICT __restrict
        ...
        #define RADINLINE __inline
         ...
         !defined(__RADPSP__) && !defined(__RADPS3__)  && !defined(__RADSPU__) && \
