...
//-----------------------------------------------------------------------------
bool UtlStringLessFuncInternal( const CUtlString &lhs, const CUtlString &rhs )
{
...
CGameUISystemMgr::CGameUISystemMgr() :
	m_MenuSoundMap(UtlStringLessFuncInternal),
	m_ScreenControllerMap(UtlStringLessFuncInternal),
	m_GraphicClassMap(UtlStringLessFuncInternal)
{
